...
mathjax: true
---
> 比赛地址：https://atcoder.jp/contests/abc188 第一次打，太菜了只写出了3/6
> 
...
这里大概的意思就是说：高桥要使用给出的所有服务，这些服务从$a_i$天开始到$b_i$天结束，每天需要支付$c_i$，同时该公司有另一项政策，就是订阅`Snuke Prime`，当天支付$C$后就可以使用当天出现的所有服务，不用额外的付钱。比如样例一，第一项服务第一天支付4，第二天支付6同时使用第一项服务和第二项服务，总共10，这样消费是最小的。
...
这个F其实很简单...甚至我之前也做过类似的题（[吃掉-N-个橘子的最少天数](http://imlgw.top/2019/09/01/leetcode-dong-tai-gui-hua/#1553-%E5%90%83%E6%8E%89-N-%E4%B8%AA%E6%A9%98%E5%AD%90%E7%9A%84%E6%9C%80%E5%B0%91%E5%A4%A9%E6%95%B0)），但是比赛的时候题都没看😂
